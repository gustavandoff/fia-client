            ...
            <div className="container py-5 my-5 h-100">
                ...
                <div className="row d-flex justify-content-center align-items-center h-50">
                    <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                        <a onClick={() => linkClicked('/creategame')} className='card text-center btn btn-primary bg-col-primary stretched font-size-2 text-nowrap py-5 m-2' style={{ borderRadius: '2rem' }}>Skapa nytt spel</a>
                    </div>

                    <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                        <a onClick={() => linkClicked('/joingame')} className='card text-center btn btn-primary bg-col-primary stretched font-size-2 text-nowrap py-5 m-2' style={{ borderRadius: '2rem' }}>Gå med i spel</a>
                    </div>
                </div>
            </div>
        </div>
